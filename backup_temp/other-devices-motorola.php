...
<title>Boise Motorola Phone Repair | iGeek Repair | Apple Product Repairs</title>
<meta name="description" content="iGeek Repair professionals, iGeek Repair is proud to offer repair services for your iphones, iPad, iPod or Macbook. We service Motorola smartphones and Androids." />
...
<div id="main-body-sub" class="fluid ">
	<div class="gridContainer clearfix">
    	<div id="main-content-sub" class="fluid "> <h1>Motorola Devices</h1>
<p>iGeek Repair services a wide range of Motorola devices for customers. To find out our current pricing on your specific phone, give us a call at 208-391-3491 or <a href="contact.php">contact us online </a>and we'll be ready to help!<br />
</p> <br>
          </p>
    	  <h2>Models We Service Include:</h2>
        <div class="fluid product-display-left"><strong class="style2"><img src="images/m-droid-razr-xt912.png" alt="boise Motorola Droid Razr XT912" class="nobord"/><br>
        <span class="productnav">Motorola Droid Razr XT912</span></strong><br>
         <h4>Screen Repair: $80</h4>
          </div>
    <div class="fluid product-display"><strong class="style2"><img src="images/m-droid-razr-m-xt907.png" alt="boise Motorola Droid Razr M XT907 " class="nobord"/><br>
        <span class="productnav">Motorola Droid Razr M XT907 
        </span></strong>
        <br>
        <h4>Screen Repair: $80</h4>
        </div>
    <div class="fluid product-display"><strong class="style2"><img src="images/m-droid-mini-xt-1030.png" alt="boise Motorola Droid Mini XT1030" class="nobord"/><br>
        <span class="productnav">Motorola Droid Mini XT1030</span></strong>
        <br>
        <h4>Screen Repair: $90</h4>
        </div>   
    <div class="fluid product-display"><span class="style2"><img src="images/m-moto-x-xt1060.png" alt="boise Motorola Moto X XT1060 " class="nobord"/><br>
        <span class="productnav">Motorola Moto X XT1060 </span></span>
        <br>
        <h4>Screen Repair: $130</h4>
        </div>
    <div class="fluid product-display"><strong class="style2"><img src="images/m-moto-x2-xt1096.png" alt="boise Motorola Moto X2 XT1096" class="nobord"/><br>
        <span class="productnav">Motorola Moto X2 XT1096</span></strong>
        <br>
        <h4>Screen Repair: $180</h4>
        </div> 
 
 <div class="fluid product-display"><strong class="style2"><img src="images/m-droid-ultra-xt1080.png" alt="boise Motorola Droid Ultra XT1080" class="nobord"/><br>
   <span class="productnav">Motorola Droid Ultra XT1080</span></strong><br>
 <h4>Screen Repair: $150</h4>
 </div> 

    <div class="fluid product-display-left"><strong class="style2"><img src="images/m-droid-turbo-xt1254.png" alt="boise Motorola Droid Turbo XT1254" class="nobord"/><br>
      <span class="productnav">Motorola Droid Turbo XT1254 </span></strong>
      <br>
      <h4>Screen Repair: $250</h4>
      </div>    
