...
<!--<![endif]--><?php //103.41.212.22.  ?>
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Boise LG Phone Repair | iGeek Repair | Apple Product Repairs</title>
<meta name="description" content="iGeek Repair professionals, iGeek Repair is proud to offer repair services for your iphones, iPad, iPod or Macbook. We service LG smartphones and Androids." />
...
<div id="main-body-sub" class="fluid ">
	<div class="gridContainer clearfix">
    	<div id="main-content-sub" class="fluid "> <h1>LG Devices</h1>
<p>iGeek Repair services a wide range of LG devices for customers. To find out our current pricing on your specific phone, give us a call at 208-391-3491 or <a href="contact.php">contact us online </a>and we'll be ready to help!<br />
  <br />
</p>          </p>
    	  <h2>Models We Service Include:</h2>
          <div class="fluid product-display-left">
    <strong class="productnav"><img src="images/lg-optimus-g2.jpg" alt="boise iphone 3" class="nobord"/><br>LG G2</strong>
  <br>
    <h4>Screen Repair: $120</h4>
  </div>
  
  <div class="fluid product-display">
    <strong class="productnav"><img src="images/lg-g3.png" alt="boise iphone 3" class="nobord"/><br>
    <span class="productnav">LG G3</span></strong><br>
    <h4>Screen Repair: $130</h4>
  </div>
  
  <div class="fluid product-display">
    <strong class="productnav"><img src="images/lg-g4.png" alt="boise iphone 3" class="nobord"/><br>
    <span class="productnav">LG G4</span></strong><br>
    <h4>Screen Repair: $140</h4>
  </div>
