...
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($_FILES['photo']['name']) && !empty($link)) {
        ...
        $insert=array('photo'=>$photo, 'link'=>$link, 'date'=>date('Y-m-d'), 'status'=>1);
    ...
    if (!empty($link)) {
        ...
        if (!empty($_FILES['photo']['name'])) {
            ...
            $photo=$ex_photo;
        }$upd2=array('photo'=>$photo, 'link'=>$link, 'date'=>date('Y-m-d'), 'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Home Slider</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Home Slider</a></li>
                    <li><a href="home_slider_data.php">Home Slider List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Home Slider</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='link' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "link"); ?>' placeholder='Link' class='form-control' />
                                    </div>
                                </div><div class="form-group">
                    ...
                    <?php }else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Home Slider</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='link' placeholder='Link' class='form-control' />
                                    </div>
                                </div><div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
