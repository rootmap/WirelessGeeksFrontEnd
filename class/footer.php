...
<div id="stretch-footer" class="fluid ">
    <div class="gridContainer clearfix">
        <div id="foot-left" class="fluid ">
            <a href="<?php echo $obj->LbaseUrl(); ?>home"><img width="200" src="<?php echo $obj->LbaseUrl(); ?>images/foot-logo.png" alt="iGeek Repair" class="nobord"/></a>
            <a href="<?php echo $obj->LbaseUrl(); ?>home"><img   width="200"  src="<?php echo $obj->LbaseUrl(); ?>images/anc.png" alt="iGeek Repair" class="nobord"/></a>
        </div>
        ...
        <div id="foot-center" class="fluid ">
            ...
            <!--<a href="http://www.genbook.com/bookings/slot/reservation/30201806?bookingSourceId=3001" target="_blank"><img src="<?php echo $obj->LbaseUrl(); ?>images/foot-book.jpg" alt="iGeek Repair email" class="nobord"/></a>--></div>
