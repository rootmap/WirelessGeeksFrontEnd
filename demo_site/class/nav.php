        ...
        <ul>
            ...
            if (!empty($sqlstores)) {
                foreach ($sqlstores as $store):
                    ?>
                    <li class='active'><a href='<?php echo $obj->LbaseUrl(); ?>store/<?php echo $store->id; ?>/<?php echo $store->name; ?>'><span><?php echo $store->name; ?></span></a></li>
                    <?php
                endforeach;
            }
            ?>
        ...
        <ul>
            ...
            if (!empty($sqladse)) {
                foreach ($sqladse as $adse):
                    ?>
                    <li><a href="<?php echo $obj->LbaseUrl(); ?>AD-SE/<?php echo $adse->id; ?>/<?php echo $obj->CleanStringDashUrl($adse->title); ?>"><?php echo $adse->title; ?></a></li>
                    <?php
                endforeach;
            }
            ?>
