...
$table="second_navigation_bar";
?>
<?php
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($menu_name) && !empty($menu_link) && !empty($priority)) {
        $insert=array('menu_name'=>$menu_name, 'menu_link'=>$menu_link, 'priority'=>$priority, 'date'=>date('Y-m-d'), 'status'=>1);
    ...
    if (!empty($menu_name) && !empty($menu_link) && !empty($priority)) {
        ...
        $upd2=array('menu_name'=>$menu_name, 'menu_link'=>$menu_link, 'priority'=>$priority, 'date'=>date('Y-m-d'), 'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Second Navigation Bar</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Second Navigation Bar</a></li>
                    <li><a href="second_navigation_bar_data.php">Second Navigation Bar List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Second Navigation Bar</h4>
                        </div>
                        <!-- // Widget heading END -->
...
<?php }else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Second Navigation Bar</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' style="color: #000;" name='menu_link' value="<?php echo $obj->LbaseUrl(); ?>" placeholder='Menu Link' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Priority </label>
