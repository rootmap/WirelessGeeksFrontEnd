    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="about_us_41"></div>
            </div>
        </div>
        <!-- // About US END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},name_heading: {type: "string"},photo: {type: "string"},page_content: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#about_us_41").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "name_heading", title: "Name Heading"},{field: "photo", title: "Photo"},{field: "page_content", title: "Page Content"},
