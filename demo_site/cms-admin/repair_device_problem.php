...
$table="repair_device_problem";
?>
<?php
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($device) && !empty($device_version) && !empty($problem_name) && !empty($repair_fix_price) && !empty($_FILES['problem_photo']['name'])) {
        ...
        $insert=array('device'=>$device, 'device_version'=>$device_version, 'problem_name'=>$problem_name, 'repair_fix_price'=>$repair_fix_price, 'problem_photo'=>$problem_photo, 'date'=>date('Y-m-d'), 'status'=>1);
    ...
    extract($_POST);
    if (!empty($device) && !empty($device_version) && !empty($problem_name) && !empty($repair_fix_price)) {
        ...
        if (!empty($_FILES['problem_photo']['name'])) {
            ...
            $problem_photo=$ex_photo;
        }$upd2=array('device'=>$device, 'device_version'=>$device_version, 'problem_name'=>$problem_name, 'repair_fix_price'=>$repair_fix_price, 'problem_photo'=>$problem_photo, 'date'=>date('Y-m-d'), 'status'=>1);
        $update_merge_array=array_merge($updatearray, $upd2);
        if ($obj->update($table, $update_merge_array) == 1) {
            $plugin->Success("Successfully Updated", "repair_device_problem_data.php");
        }else {
            $plugin->Error("Failed", $obj->filename());
        }
    }
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Repair Device Problem</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Repair Device Problem</a></li>
                    <li><a href="repair_device_problem_data.php">Repair Device Problem List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Repair Device Problem</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-6'>
                                        <?php $device_version=$obj->SelectAllByVal($table, "id", $_GET['edit'], "device_version"); ?>
                                    ...
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Problem Name </label>

                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='problem_name' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "problem_name"); ?>' placeholder='Problem Name' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                    ...
                    <?php }else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Repair Device Problem</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='problem_name' placeholder='Problem Name' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Repair Fix Price </label>
