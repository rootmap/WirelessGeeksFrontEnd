...
<div id="main-body-sub" class="fluid ">
	<div class="gridContainer clearfix">
        ...
        <h1>Console Repair</h1>
       
        </p>
        <h2>Choose Your Game Console:</h2>
        <div class="fluid product-display-left"><strong class="productnav"><a href="console-playstation.php" target="_blank"><img src="images/console-playstation.jpg" alt="boise iphone 3" class="nobord"/></a><br>
          <span class="productnav">Playstation</span></strong><br>
          </div>
    <div class="fluid product-display"><strong class="productnav"><a href="console-xbox.php" target="_blank"><img src="images/console-xbox.jpg" alt="boise iphone 3" class="nobord"/><br>
    </a>Xbox</strong></div>
    
    
    <div class="fluid product-display"><strong class="productnav"><a href="console-nintendo.php" target="_blank"><img src="images/console-nintendo.jpg" alt="boise iphone 3" class="nobord"/></a><br>
      Nintendo</strong></div>   
