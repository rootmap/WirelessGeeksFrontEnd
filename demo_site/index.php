...
<!--[if gt IE 8]><!--> <html class="">
    ...
    <body onLoad="MM_preloadImages('<?php echo $obj->LbaseUrl(); ?>images/but-find-store-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/button-highest-quality-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/button-fast-reliable-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/button-satisfaction-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/green-iphone-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/green-macbooks-ov.png', '<?php echo $obj->LbaseUrl(); ?>images/green-other-ov.png')">
        ...
        <div  class="clearfix"></div>
        <?php
        $sqlslider=$obj->FlyQuery("SELECT * FROM home_slider");
        if (!empty($sqlslider)):
            ?>
            <div id="stretch-slide" style="position: relative; clear: both;" class="fluid ">
                <?php
        ...
        <div id="stretch-nav" class="fluid" style="margin-top:-2px;">
            <div class="gridContainer clearfix">
                <div id="nav-hold" class="fluid ">
                    <div id='cssmenu'>
                        <?php include('./class/nav2.php'); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php /* <div id="stretch-mid" class="fluid " style="margin-top: -1px;">
          <div class="gridContainer clearfix">
        ...
        <div id="stretch-green" class="fluid ">
            <div class="gridContainer clearfix">
                <div id="green-title" class="fluid ">iGeek Repair Center<br>
                    Electronic Device Repair Shop
                </div>
                <?php
                $sqlcatimg=$obj->FlyQuery("SELECT id,photo FROM category_slider_images");
                if (!empty($sqlcatimg)) {
                    ?>
                    <div id="green-left" class="fluid "><a href="<?php echo $obj->LbaseUrl(); ?>repair/1/Iphone" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('boise iphones', '', '<?php echo $obj->LbaseUrl(); ?>cms-admin/upload/<?php echo $sqlcatimg[0]->photo; ?>', 1)"><img src="<?php echo $obj->LbaseUrl(); ?>images/t1.png" alt="iGeek Repair" class="nobord" id="boise iphones"></a></div>
                    <div id="green-mid" class="fluid "><a href="<?php echo $obj->LbaseUrl(); ?>repair/5/Macbook" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('macbooks', '', '<?php echo $obj->LbaseUrl(); ?>cms-admin/upload/<?php echo $sqlcatimg[1]->photo; ?>', 1)"><img src="<?php echo $obj->LbaseUrl(); ?>images/t2.png" alt="macbook repair boise" class="nobord" id="macbooks"></a></div>
                    <div id="green-right" class="fluid "><a href="<?php echo $obj->LbaseUrl(); ?>repair/6/Other Devices" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('devices', '', '<?php echo $obj->LbaseUrl(); ?>cms-admin/upload/<?php echo $sqlcatimg[2]->photo; ?>', 1)"><img src="<?php echo $obj->LbaseUrl(); ?>images/t3.png" alt="android repair boise" class="nobord" id="devices"></a></div>
                    <?php
                }
                ?>
            </div>
